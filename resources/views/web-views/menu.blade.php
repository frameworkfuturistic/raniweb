    ...
    <div id="topbar" class="hoc clear">
        ...
        <div class="fl_right">
            <ul class="faico clear">
                <li><a target="_blank" class="faicon-facebook" href="https://www.facebook.com/ranihospitalranchi/"><i class="fa fa-facebook"></i></a></li>
                <li><a class="faicon-pinterest" href="#"><i class="fa fa-pinterest"></i></a></li>
                <li><a class="faicon-twitter" href="https://twitter.com/ranihospital" target="_blank"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="col-xs-4 header-logo">
                ...
                <a href="index.php" style="text-decoration: none;">
                    <h2 class="hidden-xs rani-head">
                        <img src="img/logo2.png" alt="" height="80" style="margin-top: -25px; margin-right:4px;"><img src="doctors/Logo_1.png" alt="">
                    </h2>
                    <!-- visible for mobile only -->
                    <h2 style="text-shadow:4px 3px 0px #095599, 9px 8px 0px rgba(57, 43, 151, 0.15);margin-bottom:0px;color:rgb(245, 251, 255);font-family:Anton, sans-serif; font-size:40px; margin-top:10px;" class="visible-xs"><img src="img/mobilelogo.png" style="margin-top: -50px;"></h2>
                    <!-- visible for mobile only -->
                </a>
